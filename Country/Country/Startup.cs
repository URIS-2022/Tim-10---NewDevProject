...
namespace Country
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(setupAction =>
            {
                setupAction.SwaggerDoc("AddressOpenApiSpecification",
                    new Microsoft.OpenApi.Models.OpenApiInfo()
                    {
                        ...
                        Description = "With this API you can add a address, update it as well as review all addresses",
            ...
            services.AddDbContext<CountryContext>(options => options.UseSqlServer(Configuration.GetConnectionString("CountryDB")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                setupAction.SwaggerEndpoint("/swagger/AddressOpenApiSpec/swagger.json", "Address API");
