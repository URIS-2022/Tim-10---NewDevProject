...
namespace PublicBidding.Data
{
	public class UserMockRepository : IUserRepository
	{
		...
		/// <summary>
		/// Checks if there is a user with the passed credentials
		/// </summary>
		...
		public bool UserWithCredentialsExists(string username, string password)
		{
			...
			// If there is a user with that username, we check the password
		...
		/// <returns>Hash and salt generated</returns>
